...
abstract class AppColors {
  ...
  static const Color errorReadable = Color(0xFFFF8A80);
  static const Color warning = Color(0xFFF57C00);
  static const Color info = Color(0xFF0277BD);
  static const Color aiPurple = Color(0xFF7C3AED);
  static const Color aiBlue = Color(0xFF2563EB);
  static const Color aiPink = Color(0xFFDB2777);

  // ── Dark Theme ──────────────────────────────────────────────────
  static const Color darkBackground = Color(0xFF0A1A1C);
  static const Color darkSurface = Color(0xFF00565B);
  static const Color darkCard = Color(0xFF0B6668);
  static const Color darkBorder = Color(0xFF1F8587);
