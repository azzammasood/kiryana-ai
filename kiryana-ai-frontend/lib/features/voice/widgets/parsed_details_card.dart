...
class ParsedDetailsCard extends ConsumerWidget {
  const ParsedDetailsCard({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    const data = VoiceMockData.parsedData;
    final isSale = data['is_sale'] as bool;
              ...
              child: Column(
                children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            if (isUrdu)
                              Text(
                                isSale ? '(${AppStrings.saleUrdu})' : '(اخراجات)',
                  ...
                  _buildDetailRow(
                    ...
                    urduVal: data['item_urdu'],
                    engVal: data['item_english'],
                  ),
                  const SizedBox(height: AppSpacing.md),
                  _buildDetailRow(
                    isUrdu: isUrdu,
