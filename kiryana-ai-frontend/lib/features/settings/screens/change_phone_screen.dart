...
class _ChangePhoneScreenState extends ConsumerState<ChangePhoneScreen> {
  ...
  void _sendOtp() async {
    ...
    if (!phoneRegExp.hasMatch(phone)) {
      AppToast.show(
        context,
        isUrdu ? 'براہ کرم درست فون نمبر درج کریں' : 'Please enter a valid phone number',
        isError: true,
      );
      return;
    }
    ...
    if (mounted) {
      ...
      AppToast.show(
        context,
        isUrdu ? 'او ٹی پی بھیج دیا گیا ہے (Mock: 4 ہندسے درج کریں)' : 'OTP sent successfully! (Mock: enter any 4 digits)',
      );
    }
  }
  ...
  void _verifyOtp() async {
    ...
    if (mounted) {
      ...
      AppToast.show(
        context,
        isUrdu ? 'فون نمبر کامیابی کے ساتھ اپ ڈیٹ ہو گیا!' : 'Phone number updated successfully!',
      );
      context.pop();
    }
  }
      ...
      appBar: PreferredSize(
        ...
        child: Directionality(
          ...
          child: AppBar(
            ...
            title: Text(
              isUrdu ? 'فون نمبر تبدیل کریں (Change Phone)' : 'Change Phone Number',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(Icons.phone_android_rounded, size: 80, color: AppColors.primary.withValues(alpha: 0.8)),
            ...
            Directionality(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: _otpSent ? AppColors.border.withValues(alpha: 0.3) : AppColors.white,
                ...
                child: _isLoading 
                    ...
                    : Text(
                        _otpSent 
                          ...
                          : (isUrdu ? 'او ٹی پی بھیجیں (Send OTP)' : 'Send OTP'),
